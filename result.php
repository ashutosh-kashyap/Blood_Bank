...
<div class="wrap">
		<ul class="nav">
			...
			<li><a href="index.php">Donor Registration</a></li>            
...
?>
 ...
 <a href="doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" /></a></td>
           ...
           <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td>&nbsp&nbsp&nbsp&nbsp<span class="title">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td><td><?php echo $data[1]; ?></td><td align="left" width="50%"></td></tr>
                 <tr><td>&nbsp&nbsp&nbsp&nbsp<span class="title">Gender</span></td><td><?php echo $data[2]; ?></td></tr>
                  <tr><td style="width:24px">&nbsp&nbsp&nbsp&nbsp<span class="title">Mobile No:</span></td><td><?php echo $data[4]; ?></td></tr>
                  <tr><td>&nbsp&nbsp&nbsp&nbsp<span class="title">Email</span></td><td><?php echo $data[6]; ?></td></tr>
                   <tr><td>&nbsp&nbsp&nbsp&nbsp<span class="title">Blood Group</span></td><td><?php echo $data[10]; ?></td></tr>
